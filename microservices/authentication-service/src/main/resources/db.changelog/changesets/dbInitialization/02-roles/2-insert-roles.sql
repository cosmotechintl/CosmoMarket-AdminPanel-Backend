...
VALUES ('Root', '', 'Root', 'NONE', 'ROOT', 'NONE', 0, 'NONE',0),
       ('Vendors', 'IoBusinessOutline', 'Vendors', '/vendor', 'Root', 'VENDOR', 1, 'NONE',0),
       ('Create Vendor', '', 'Create Vendor', 'create', 'Vendors', 'CREATE_BANK', 1, 'Vendors',0),
       ('View Vendor', '', 'View Vendor', 'view', 'Vendors', 'VIEW_VENDOR', 2, 'Vendors',0),
       ('Modify Vendor', '', 'Modify Vendor', 'edit', 'Vendors', 'MODIFY_VENDOR', 3, 'Vendors',0),
       ('Delete Vendor', '', 'Delete Vendor', 'delete', 'Vendors', 'DELETE_VENDOR', 4, 'Vendors',0),
       ('Block Vendor', '', 'Block Vendor', 'block', 'Vendors', 'BLOCK_VENDOR', 5, 'Vendors',0),
       ('UnBlock Vendor', '', 'UnBlock Vendor', 'unblock', 'Vendors', 'UNBLOCK_VENDOR', 6, 'Vendors',0),
       ('Reopen Vendor', '', 'Reopen Vendor', 'reopen', 'Vendors', 'REOPEN_VENDOR', 7, 'Vendors',0),
       ('Unlock Vendor Controller', '', 'Unlock Vendor Controller', 'unlock', 'Vendors', 'UNLOCK_VENDOR_ADMIN', 8,
        'Vendors',0),
       ('Reset Password Vendor Controller', '', 'Reset Password Vendor Controller', 'reset', 'Vendors',
        'RESET_PASSWORD_VENDOR_ADMIN', 9, 'Vendors',0),
       ('Resend Account Activation Link Vendor Controller', '', 'Resend Account Activation Link Vendor Controller',
        'resend', 'Vendors', 'RESEND_ACCOUNT_ACTIVATION_LINK_VENDOR_ADMIN', 10, 'Vendors',0),
       ('Resend Vendor Activation Link', '', 'Resend Vendor Activation Link', 'resendVendor', 'Vendors',
        'RESEND_VENDOR_ACTIVATION_LINK', 11, 'Vendors',0),
       ('Resend Vendor And Vendor Controller Activation Link', '',
        'Resend Vendor And Vendor Controller Activation Link', 'resendVendorAndVendorAdmin', 'Vendors',
        'RESEND_VENDOR_AND_VENDOR_ADMIN_ACTIVATION_LINK', 12, 'Vendors',0),
       ('Vendor Setup', '', 'Vendor Setup', 'setup', 'Vendors', 'VENDOR_SETUP', 13, 'Vendors',0),
       ...
       ('Reset Two Factor Authentication Vendor Controller', '', 'Reset Two Factor Authentication Vendor Controller',
        'resetTwoFactorAuth', 'Vendors', 'RESET_TWO_FACTOR_AUTHENTICATION_VENDOR_CONTROLLER', 14, 'Venodrs',0),
       ('Reports', 'TbReportSearch', 'Reports', '/reports', 'Root', 'REPORTS', 4, 'NONE',0),
       ('Vendor Reports', 'msi-Vendor-reports', 'Vendor Reports', 'vendorReports', 'Reports', 'VIEW_VENDOR_REPORTS', 3,
        'Reports',0),
       ('Customers', 'IoPersonOutline', 'Customers', '/customer', 'Root', 'CUSTOMER', 10, 'NONE',0),
       ...
       ('Admin Users', 'GrUserAdmin', 'Admin Users', '/adminUser', 'Root', 'ADMIN_USER', 11, 'NONE',0),
       ...
       ('Settings', 'IoSettingsOutline', 'Settings', '/setting', 'Root', 'SETTING', 13, 'NONE',0),
       ('Style Guide', 'MdDesignServices', 'Style Guide', '/styleGuide', 'Root', 'STYLE_GUIDE', 14, 'NONE',0),
       ('Vendor Profile', 'IoBusinessOutline', 'Vendor Profile', '/vendorProfile', 'Root', 'VENDOR_PROFILE', 2, 'NONE',0),
